...
<section class="login-container">
    <div class="card shadow-lg">
        <div class="card-header">
            <img src="https://img.freepik.com/free-vector/hand-drawn-flat-design-stack-books-illustration_23-2149341898.jpg" width="5%" height="5%" alt="..." class="img-logo">
        ...
        <div class="card-footer">
            <a href="#">
                <p class="text-primary text-center">Tidak punya akun? Sila
                    hkan mendaftar</p>
            </a>
        </div>
    </div>
